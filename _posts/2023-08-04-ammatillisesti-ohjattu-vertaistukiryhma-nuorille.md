...
Vertaistuen avulla ryhmä tarjoaa nuorille hyvän alustan tutustua itseensä, omaan arvomaailmaansa sekä ainutlaatuisuutensa suhteessa muihin. Vertaistuellinen ryhmä antaa myös ymmärrystä siitä, että jokaisen neurokirjo on omanlaista ja ilmenee kaikilla eri tavoin ja eri asioissa. Tämä kokemus voi tarjota nuorelle vapautumisen diagnoosin kahleista, jos hän on ajatellut itsensä liian ahtaaseen malliin. Toisaalta taas samankaltaiset kokemusten muiden kanssa voivat tarjota nuorelle hänen kaipaamaansa kokemusta siitä, että ei olekaan ainut ihminen ongelmineen, vaan muutkin kokevat samanlaisia vaikeuksia. Ylpeys omista vahvuuksista voi myös lisääntyä, kun jokainen saa kokea ainutlaatuisuutta omana itsenään kaikkine piirteineen. 
...
Sosiaalinen toimintakyky kehittyy tietysti sosiaalisissa tilanteissa, joten kaikki yhdessä oleminen ja tekeminen on hyvästä. Sosiaalisessa toimintakyvyssä on syytä huomioida yksilöllisten motivaatiotekijöiden vaikutus nuorten sosiaalisiin tavoitteisiin. Mikä luo nuorelle halua luoda ja ylläpitää sosiaalisia suhteita? Haluaako nuori läheisyyttä vai etäisyyttä, vaikutusmahdollisuuksia vai mukautumista? Vertaisryhmäajatus vastaa eettiseen kysymykseen ”kuka määrittelee minkälaista sosiaalista toimintakykyä tavoitellaan?”. Vertaisryhmässä jokainen nuori voi itse pohtia ja määritellä omat sosiaaliset tavoitteensa ja peilata itseään ja toimintatapojaan sekä muihin nuoriin, ohjaajiin että yhteiskuntaan. Ryhmä tukee myös jokaisen myönteistä sosiaalista minäkuvaa, eli uskoa kykyynsä toimia sosiaalisissa suhteissa ja tilanteissa. Ammatillinen ohjaus tarjoaa sosiaalisen toimintakyvyn tukemiseen ymmärrystä omasta biologiastaan ja neurologiastaan sekä niiden vaikutuksista toimintaansa ja käyttäytymiseensä. Muut nuoret tarjoavat myös esimerkkiä näiden vaikutuksista ja laajentaa ryhmäläisten ymmärrystä itsestään. Kokemusasiantuntijana toimiva apuohjaaja toimii tärkeänä esimerkkinä ja mallina nuorille. Ryhmä toimii nuorille motivoivana tekijänä uskaltaa opetella, harjoitella ja käyttää sosiaalista toimintakykyään ja ryhmässä voidaan käsitellä myös emootioiden säätelykykyä sekä neurokognitiivisia toimintoja.
...
Pääpointti ryhmässä on siis ollut itsensä hyväksyminen sellaisena kuin. Kun tietää missä on ja hyväksyy tilanteensa vertaistuen voimin, on siitä hyvä lähteä ponnistamaan elämässä siihen suuntaan kuin itse toivoo. Toisten ryhmäläisten kannustuksen ja hyväksynnän avulla on helpompi nähdä omat vahvuudet ja ainutlaatuisuuden. Kenenkään ei tarvitse tehdä ryhmässä mitään mitä ei halua, eikä ryhmässä ole pakko olla, jos ei halua. Jokainen osallistuu ryhmään omalla tavallaan, omalla panoksellaan, itsensä näköisesti ja omasta mukavuusalueestaan käsin. Erilaiset nuoret tuovat jokainen ryhmään omia puoliaan, jolloin toimintakin muotoutuu sopivasti vaihtelevaksi. Liikunnalliset nuoret toivat liikkumista ja liikunnallisuutta, pohtivat nuoret keskustelua ja ajatusten sekä kokemusten vaihtoa, vaikeuksia kokeneet nuoret keinoja!
